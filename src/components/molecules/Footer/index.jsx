    ...
    return (
      <MDBFooter color="agency-dark" className="font-small pt-4">
          ...
          <MDBRow>
            <MDBCol md="3" className="runes">
              <h5 className="title font-weight-bold">
                Ich bin Sebastian Sonnenarm
              </h5>
              <img className="img-fluid" src={Sign} alt="Sebastian" />
              <p>
                : Årle ell i dagars hell :<br />: enn veit ravnen om eg fell :
              </p>
            </MDBCol>
            <MDBCol md="9" className="h-auto flex-center">
              <MDBRow className="text-center">
                <MDBCol md="12">
                  <p className="runes font-weight-bold">
                    Wie du mich unterstützen kannst
                  </p>
                </MDBCol>
                <MDBCol md="12">
                  <a href="https://patreon.com/sonnenarm">
                    <MDBBtn color="orange">
        ...
        <div className="footer-copyright text-center py-3">
          <MDBContainer fluid>
            <Link to="/about">Impressum</Link> | &copy;{" "}
            {new Date().getFullYear()} Copyright: Sebastian Fritzer
